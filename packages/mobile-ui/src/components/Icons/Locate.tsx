  ...
  <Svg width="1em" height="1em" viewBox="0 0 1024 1024" {...props}>
    <Defs>
      <Path
        ...
        id="locate_svg__path-1"
      />
    </Defs>
    <G
      id="locate_svg__Symbols"
      stroke="none"
      strokeWidth={1}
      fill="none"
      fillRule="evenodd">
      <G id="locate_svg__locate">
        <Mask id="locate_svg__mask-2" fill="#fff">
          <Use xlinkHref="#locate_svg__path-1" />
        </Mask>
        <Use
          id="locate_svg__76"
          fill={props.color}
          fillRule="nonzero"
          xlinkHref="#locate_svg__path-1"
        />
      </G>
    </G>
  </Svg>

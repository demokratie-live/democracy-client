  ...
  <Svg width="1em" height="1em" viewBox="0 0 1024 1024" {...props}>
    <Defs>
      <Path
        ...
        id="camera_svg__path-1"
      />
    </Defs>
    <G
      id="camera_svg__Symbols"
      stroke="none"
      strokeWidth={1}
      fill="none"
      fillRule="evenodd">
      <G id="camera_svg__camera">
        <Mask id="camera_svg__mask-2" fill="#fff">
          <Use xlinkHref="#camera_svg__path-1" />
        </Mask>
        <Use
          id="camera_svg__130"
          fill={props.color}
          fillRule="nonzero"
          xlinkHref="#camera_svg__path-1"
        />
      </G>
    </G>
  </Svg>

  ...
  <Svg width="1em" height="1em" viewBox="0 0 1024 1024" {...props}>
    <Defs>
      <Path
        ...
        id="umbrella_svg__path-1"
      />
    </Defs>
    <G
      id="umbrella_svg__Symbols"
      stroke="none"
      strokeWidth={1}
      fill="none"
      fillRule="evenodd">
      <G id="umbrella_svg__umbrella">
        <Mask id="umbrella_svg__mask-2" fill="#fff">
          <Use xlinkHref="#umbrella_svg__path-1" />
        </Mask>
        <Use
          id="umbrella_svg__80"
          fill={props.color}
          fillRule="nonzero"
          xlinkHref="#umbrella_svg__path-1"
        />
      </G>
    </G>
  </Svg>

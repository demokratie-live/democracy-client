  ...
  <Svg width="1em" height="1em" viewBox="0 0 1024 1024" {...props}>
    <Defs>
      <Path
        ...
        id="heard-filled_svg__path-1"
      />
    </Defs>
    <G
      id="heard-filled_svg__Symbols"
      stroke="none"
      strokeWidth={1}
      fill="none"
      fillRule="evenodd">
      <G id="heard-filled_svg__filled/heard">
        <Mask id="heard-filled_svg__mask-2" fill="#fff">
          <Use xlinkHref="#heard-filled_svg__path-1" />
        </Mask>
        <Use
          id="heard-filled_svg__90"
          fill={props.color}
          fillRule="nonzero"
          xlinkHref="#heard-filled_svg__path-1"
        />
      </G>
    </G>
  </Svg>

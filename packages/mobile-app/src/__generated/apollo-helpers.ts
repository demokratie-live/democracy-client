...
export type QueryKeySpecifier = ('activityIndex' | 'currentConferenceWeek' | 'deputiesOfConstituency' | 'deputies' | 'deputy' | 'notificationSettings' | 'procedure' | 'procedures' | 'proceduresById' | 'proceduresByIdHavingVoteResults' | 'notifiedProcedures' | 'searchProcedures' | 'searchProceduresAutocomplete' | 'votedProcedures' | 'proceduresWithVoteResults' | 'recommendedProcedures' | 'showRecommendations' | 'mostSearched' | 'me' | 'votes' | 'communityVotes' | 'voteStatistic' | QueryKeySpecifier)[];
...
export type RecommendationGroupKeySpecifier = ('title' | 'procedures' | RecommendationGroupKeySpecifier)[];
export type RecommendationGroupFieldPolicy = {
	title?: FieldPolicy<any> | FieldReadFunction<any>,
	procedures?: FieldPolicy<any> | FieldReadFunction<any>
};
export type RecommendedProceduresResultKeySpecifier = ('total' | 'hasMore' | 'data' | RecommendedProceduresResultKeySpecifier)[];

...
export type QueryKeySpecifier = ('activityIndex' | 'currentConferenceWeek' | 'deputiesOfConstituency' | 'notificationSettings' | 'procedure' | 'procedures' | 'proceduresById' | 'proceduresByIdHavingVoteResults' | 'notifiedProcedures' | 'searchProcedures' | 'searchProceduresAutocomplete' | 'votedProcedures' | 'proceduresWithVoteResults' | 'mostSearched' | 'me' | 'votes' | 'communityVotes' | 'voteStatistic' | QueryKeySpecifier)[];

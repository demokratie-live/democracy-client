...
import SvgGovernment from "../../Icons/Government";
import SvgWahlOMeter from "../../Icons/WahlOMeter";

export type ListsProps = SidebarProps;

const isCurrentLegislaturePeriod = (
...
const showLegislaturePeriod = (
  ...
  isCurrentLegislaturePeriod(currentParlament, parlament) ||
  legislaturePeriodSelected;
...
export const ParlamentsNavi: React.FC<ListsProps> = ({ navigation, state }) => {
  ...
  const [legislaturePeriodSelected, setLegislaturePeriodSelected] =
    useState(false);

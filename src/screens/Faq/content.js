export const faq1Title = 'Warum fehlt der Antragsteller?';
export const faq1Answer = `Immer wieder kam und kommt die Frage auf, warum wir den Antragsteller eines Papiers nicht ebenfalls unter den Detailinformationen eines Vorgangs anzeigen.
...
`;
export const faq4Section2 = '1.Beratung';
export const faq4Answer2 = `
...
`;
export const faq4Section3 = 'Überwiesen';
export const faq4Answer3 = `
...
`;
export const faq4Section4 = 'Beschlussempfehlung liegt vor';
export const faq4Answer4 = `
...
`;
export const faq4Section5 = '2.Beratung ';
export const faq4Answer5 = `
...
`;
export const faq4Section6 = '3.Beratung';
export const faq4Answer6 = `
...
`;
export const faq4Section7 = 'Abgelehnt';
export const faq4Answer7 = `
...
`;
export const faq4Section8 = 'Angenommen';
export const faq4Answer8 = `
...
`;
export const faq4Section9 = 'Unterrichtung des BR durch BT';
export const faq4Answer9 = `
...
`;
export const faq4Section10 = 'Verabschiedet';
export const faq4Answer10 = `
...
`;
export const faq10Section1 = 'LEVEL 1 – Für Einsteiger';
export const faq10Answer10 = `
...
- Like unsere `;
export const faq10Answer11 = 'Facebook-Seite';
export const faq10Link10 = 'https://www.facebook.com/democracygermany/';
export const faq10Answer12 = `
- Folge uns bei `;
export const faq10Answer13 = 'Twitter';
export const faq10Link11 = 'https://twitter.com/democracy_de';
export const faq10Answer14 = `
- Entwickler-Special: Gib uns einen `;
export const faq10Answer15 = `Stern auf Github

`;
export const faq10Link12 = 'https://github.com/demokratie-live/democracy-client';
export const faq10Section2 = 'LEVEL 2 – Für Fortgeschrittene';
export const faq10Answer20 = `
...
`;
export const faq10Section3 = 'LEVEL 3 – Für Profis';
export const faq10Answer30 = `
- Schreibe über DEMOCRACY auf Deiner eigenen Seite/Blog/Timeline
- Tritt in direkte Kommunikation mit uns via `;
export const faq10Answer31 = 'Discord';
export const faq10Link30 = 'https://discordapp.com/invite/Pdu3ZEV';
export const faq10Answer32 = ' oder ';
export const faq10Answer33 = 'per Mail';
export const faq10Link31 = 'mailto:contact@democracy-deutschland.de';
export const faq10Answer34 = `. 
...
- Entwickler-Special: Prüfe unseren `;
export const faq10Answer35 = 'Code';
export const faq10Link32 = 'https://github.com/demokratie-live';
export const faq10Answer36 = ' und/oder entwickle mit';
export const faq10Outro1 = `

Außerdem suchen wir ständig motivierte Menschen für die aktive Mitarbeit in unserem Projekt! Du hast Interesse Deine Fähigkeiten einzubringen – wir freuen uns über Anregungen, Fragen und Kritik. Hier kannst Du Dich als Freiwilliger melden – `;
export const faq10Outro2 = 'https://www.democracy-deutschland.de/#!engineering#help';
export const faq10LinkO1 = 'https://www.democracy-deutschland.de/#!engineering#help';

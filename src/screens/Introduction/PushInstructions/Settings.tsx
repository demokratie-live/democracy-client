...
type FilterScreenNavigationProp = NativeStackNavigationProp<SettingsRootStackParamList, 'Settings'>;
...
type Settings = Partial<
  Pick<
    ...
    'conferenceWeekPushs' | 'outcomePushs' | 'voteConferenceWeekPushs' | 'voteTOP100Pushs'
  >
>;
...
export const Settings: React.FC<Props> = ({
  ...
  const [settings, setNotificationSettings] = useState<Settings>(notificationSettings);
              ...
              onValueChange={value => {
                ...
                !!onPress &&
                  onPress({
                    ...
                    description: defaultNotificationData.conferenceWeekPushs.description,
                  });
              }}
            />
          ),
        ...
        },
        {
          ...
          onPress: () =>
            ...
            onPress({
              ...
              description: defaultNotificationData.voteConferenceWeekPushs.description,
            }),
          component: (
            <Switch
          ...
          onPress: () => {
            if (onPress) {
              onPress({
                ...
                description: defaultNotificationData.voteTOP100Pushs.description,
              });
            }
          },

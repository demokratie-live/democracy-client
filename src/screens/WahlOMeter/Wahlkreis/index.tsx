...
import { Avatar, Bar, ChartLegend } from '@democracy-deutschland/ui';
          ...
          if (matchingProcedures.length > 0) {
            return (
              <Wrapper>
                ...
                <ChartWrapper>
                  <MemberImageWrapper
                    onPress={() => this.props.navigation.navigate('MemberProfil')}
                  >
                    <Avatar
                      partyLogo={{
                        party: party as 'Union' | 'SPD' | 'FDP' | 'Grüne' | 'AfD' | 'Linke',
                        width: 200,
                      }}
                      profileImage={{
                        height: 270,
                  ...
                  <DeputyDetailsWrapper>
                    ...
                    <InfoIconButton onPress={() => this.props.navigation.navigate('MemberProfil')}>
                      <InfoIcon />
                    </InfoIconButton>
                  </DeputyDetailsWrapper>

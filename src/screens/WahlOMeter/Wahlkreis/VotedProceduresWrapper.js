            ...
            return (
              ...
              >
                {({ data: proceduresData }) => {
                  ...
                  if (
                    proceduresData &&
                    proceduresData.deputiesOfConstituency &&
                    proceduresData.deputiesOfConstituency[0].totalProcedures
                  ) {
                    totalProcedures = proceduresData.deputiesOfConstituency[0].totalProcedures;
                    const votedProcedures = proceduresData.deputiesOfConstituency[0].procedures.map(
                      ({ procedure, decision }) => ({
                        procedureId: procedure.procedureId,
                        decision,
                      }),
                    );
                    const { party, imgURL, name } = proceduresData.deputiesOfConstituency[0];
                    const deputy = {
                      party,
                      imgURL,
                      constituency,

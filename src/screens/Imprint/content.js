export const impressum1Head = 'Angaben gemäß § 5 TMG';
export const impressum1Text = `DEMOCRACY Deutschland e.V. (gemeinnützig)
Industriestraße 10
37079 Göttingen\n`;
...
export const datenschutz2Head = '2. Verantwortlich im Sinne der Datenschutzgesetze ist der:';
export const datenschutz2Text = `DEMOCRACY Deutschland e.V.
Industriestr. 10
37079 Göttingen

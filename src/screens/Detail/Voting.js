...
const Voting = ({
  ...
  const clickVote = selection => {
    Navigation.showModal({
      stack: {
        children: [
          {
            component: {
              name: "democracy.VoteVarification",
              options: {
                topBar: {
                  title: {
                    text: "Zur Wahlurne".toUpperCase()
                  }
                }
              },
              passProps: {
